...
## [13.0.0](https://github.com/appelgriebsch/LazyVim/compare/v12.5.0...v13.0.0) (2024-06-06)
...
* **autocmds:** added support for copy/paste through ssh. Needs Neovim &gt;= 0.10.0 ([21ca466](https://github.com/appelgriebsch/LazyVim/commit/21ca466db13e68740aa3348c7406369c53062a9e))
...
* **extras:** add harpoon2 ([#2455](https://github.com/appelgriebsch/LazyVim/issues/2455)) ([cae22ba](https://github.com/appelgriebsch/LazyVim/commit/cae22baf082dcf68c5a4074ca4f6534589d80f8d))
...
* **extras:** Add scala support using nvim-metals ([#1347](https://github.com/appelgriebsch/LazyVim/issues/1347)) ([d250261](https://github.com/appelgriebsch/LazyVim/commit/d2502613ff0fe8116a3a8891006b1a880834be15))
...
* **extras:** Enable project-specific plugin specs using local .lazy.lua ([#2115](https://github.com/appelgriebsch/LazyVim/issues/2115)) ([b949835](https://github.com/appelgriebsch/LazyVim/commit/b949835de50555b8a1c15b24361d6abb73d30808))
...
* **java:** allow opts for setup_dap_main_class_configs() ([#2581](https://github.com/appelgriebsch/LazyVim/issues/2581)) ([a7c16f8](https://github.com/appelgriebsch/LazyVim/commit/a7c16f8efd145122869ffb272d70a1229907a823))
...
* **lang:** add Haskell config ([#2052](https://github.com/appelgriebsch/LazyVim/issues/2052)) ([c6c584f](https://github.com/appelgriebsch/LazyVim/commit/c6c584f7c3263e685e064fb84f69e58d9b625f23))
...
* **lang:** add support for helm chart templates ([#2273](https://github.com/appelgriebsch/LazyVim/issues/2273)) ([de01a37](https://github.com/appelgriebsch/LazyVim/commit/de01a37cb68c3ddfb64e9576df0878a4373a6dcb))
* **lang:** add telescope terraform integrations ([#2235](https://github.com/appelgriebsch/LazyVim/issues/2235)) ([d57817d](https://github.com/appelgriebsch/LazyVim/commit/d57817d79b18a2e9aa39db129056be3adf3c8371))
...
* **lang:** replace rust-tools.nvim with rustacean.nvim [#2198](https://github.com/appelgriebsch/LazyVim/issues/2198) ([139c41c](https://github.com/appelgriebsch/LazyVim/commit/139c41c18ed7bde8dbaf5ef18afc063a96092954))
...
* **lsp:** added native codelens support. Enable in lsp settings. (disabled by default). Fixes [#2656](https://github.com/appelgriebsch/LazyVim/issues/2656) ([780b9bb](https://github.com/appelgriebsch/LazyVim/commit/780b9bb337dc57bcd7f2bf4dc8bb5be62a6ce92b))
...
* **lualine:** add more hl options to pretty_path ([#2687](https://github.com/appelgriebsch/LazyVim/issues/2687)) ([d3761ed](https://github.com/appelgriebsch/LazyVim/commit/d3761eded733b5f00e1ee14fef3fb2ce0dfb7dd0))
...
* **omnisharp:** add `nvim-dap` configuration ([#2532](https://github.com/appelgriebsch/LazyVim/issues/2532)) ([f23d3ce](https://github.com/appelgriebsch/LazyVim/commit/f23d3cee422a8b77572a8db6fe915d374625453f))
...
* **symbols-outline:** use outline.nvim instead of symbols-outline.nvim ([#2535](https://github.com/appelgriebsch/LazyVim/issues/2535)) ([a48b14e](https://github.com/appelgriebsch/LazyVim/commit/a48b14eb3e4ff03e55796dc50e08b6c8a42cccf4))
...
* **ui:** dashboard files searches git files if in git repo ([#2240](https://github.com/appelgriebsch/LazyVim/issues/2240)) ([66b3c0a](https://github.com/appelgriebsch/LazyVim/commit/66b3c0a19fe3024d4bf1da563f7ca5a9aff58dec))
...
* **ansible:** incorrect key spec ([b2a0ae6](https://github.com/appelgriebsch/LazyVim/commit/b2a0ae6d0d03270697359399bc33418493079a3d))
...
* **extras:** automatically rename extra symbols-outline =&gt; outline. Fixes [#2675](https://github.com/appelgriebsch/LazyVim/issues/2675) ([ee2e876](https://github.com/appelgriebsch/LazyVim/commit/ee2e876252c82458d47617b6d87d827ea442ddcd))
* **extras:** prevent duplicate extra imports ([935bc22](https://github.com/appelgriebsch/LazyVim/commit/935bc2283f9968a8fb1fc2466a14618a838cb904))
...
* **extras:** set correct priority for outline extra. Fixes [#2666](https://github.com/appelgriebsch/LazyVim/issues/2666) ([4745314](https://github.com/appelgriebsch/LazyVim/commit/474531407454cb69f1d09e4bc1120b9571dc8697))
...
* **extras:** show rename of symbols-outline =&gt; outline ([c6736ef](https://github.com/appelgriebsch/LazyVim/commit/c6736ef2b8962a9b0a8d5cb5916f1b11835ac090))
...
* **go:** adding opts recursive_run ([#2520](https://github.com/appelgriebsch/LazyVim/issues/2520)) ([e8e7d22](https://github.com/appelgriebsch/LazyVim/commit/e8e7d22f56f2a2dc2ca0c28b02884c0356df2015))
...
* **haskell:** Make Haskell-snippets lazy load for performance ([#2676](https://github.com/appelgriebsch/LazyVim/issues/2676)) ([04bc571](https://github.com/appelgriebsch/LazyVim/commit/04bc5718a51364dddf365ba9163b2a1c7d74071d))
...
* **hi-patterns:** correct regex for shorthand hex colors. See #[#2562](https://github.com/appelgriebsch/LazyVim/issues/2562) ([7415231](https://github.com/appelgriebsch/LazyVim/commit/7415231855f8173e9664c035a1a631da8c664948))
...
* **lang:** Change `rustacean` keymaps to `vim.keymap.set` instead of `which-key` ([#2660](https://github.com/appelgriebsch/LazyVim/issues/2660)) ([ed135e6](https://github.com/appelgriebsch/LazyVim/commit/ed135e6ffdd8dc9a43dabe62573688934e7a1bb0))
...
* **options:** dont set clipboard in an SSH session, so that OSC52 can be enabled (when supported) ([1c9f416](https://github.com/appelgriebsch/LazyVim/commit/1c9f4160a22dbdca2db36169460fcf28641607e7))
...
* **terraform-extra:** Drop unnecessary commentstring config for terraform ([#2680](https://github.com/appelgriebsch/LazyVim/issues/2680)) ([b12e742](https://github.com/appelgriebsch/LazyVim/commit/b12e7424580d4b524755eec33006d4517fa3182e))
...
* **util.ui.fg:** Add `link=false` to show effective definition ([#2542](https://github.com/appelgriebsch/LazyVim/issues/2542)) ([5012d7d](https://github.com/appelgriebsch/LazyVim/commit/5012d7d839beede3d223c361449d0d8cb00fa098))
* **util:** clear buffer root cache when cwd change ([#2502](https://github.com/appelgriebsch/LazyVim/issues/2502)) ([8386d23](https://github.com/appelgriebsch/LazyVim/commit/8386d23c817a3e3e4ee6302bd8e2902f7e297cf5))
